...
```
  ...
  Based on *table 2.2.1* we know about the net bookies probabilities and EM probabilities, as well as the 
...
draft : 
  ...
  - read *Galema, Plantinga and Scholtens (2008)*
  - reverse engineering on staking-profit linear regression model to get/retrieve EMProb value since now only get the coefficients figire of EMProb. Although incompleted soccer teams... 2ndly, reversed poison model from EMProb might is not workable on oneway competition, need to refer to some international competition as references for incompleted dataset.
```
...
## 7.2 Versions' Log
  ...
  - File version: 0.9.4 - *2016-06-22 13:36:33 JST*
...
####  Reference for industry knowdelege and academic research portion for the paper.
  ...
  18. [**The Stocks at Stake: Return and Risk in Socially Responsible Investment** *by Galema, Plantinga and Scholtens (2008)*](http://www.rug.nl/research/portal/files/2538250/02_c2.pdf)
