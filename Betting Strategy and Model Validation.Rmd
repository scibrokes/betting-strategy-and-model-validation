...
dt1 %<>% datatable(
  caption="Table 3.1.1 : Summary of Monthly Stakes and Return. ('0,000)", rownames=FALSE,
  extensions = list("ColReorder"=NULL, "ColVis"=NULL,
                      "TableTools"=NULL #, "FixedColumns"=list(leftColumns=2)
                      ), 
  options = list(autoWidth=TRUE,
                   ...
                   aButtons=list("copy", "print",
                                   list(sExtends="collection",
                                        sButtonText="Save",
                                        aButtons=c("csv","xls")))),
                   dom='CRTrilftp', scrollX=TRUE, scrollCollapse=TRUE, columnDefs=cd, fnDrawCallback=cb))
...
dt2 %<>% datatable(
  caption="Table 3.1.2 : Summary of Daily Stakes and Return. ('0,000)", rownames=FALSE,
  extensions = list("ColReorder"=NULL, "ColVis"=NULL,
                      "TableTools"=NULL #, "FixedColumns"=list(leftColumns=2)
                      ), 
  options = list(autoWidth=TRUE,
