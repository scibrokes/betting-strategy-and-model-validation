...
*table 2.1.1* `r paste0(dim(dat), collapse=' x ')`
...
*table 2.2.1* `r paste0(dim(dat), collapse=' x ')`
...
*table 3.1.1* `r paste0(ddim, collapse=' x ')`
...
*table 3.1.2* `r paste0(ddim, collapse=' x ')`
...
*table 3.2.1a* `r paste0(dim(lst[[1]]), collapse=' x ')`
...
*table 3.2.1b* `r paste0(dim(lst[[2]]), collapse=' x ')`
...
*table 3.3.1a* `r paste0(dim(lst[[1]]), collapse=' x ')`
...
*table 3.3.1b* `r paste0(dim(lst[[2]]), collapse=' x ')`
...
*table 3.4.1a* `r paste0(dim(lst[[1]]), collapse=' x ')`
...
*table 3.4.1b* `r paste0(dim(lst[[2]]), collapse=' x ')`
...
*table 3.5.1a* `r paste0(dim(lst[[1]]), collapse=' x ')`
...
*table 3.5.1b* `r paste0(dim(lst[[2]]), collapse=' x ')`
...
## 4. Staking Model
  ...
  * Section [4.2 Poisson Modelling] - aaaaa
  * Section [4.3 Kelly Model] - aaaaa
  * Section [4.4 Staking Modelling and Money Management] - aaaaa
  * Section [4.5 Expectation Maximization and Staking Simulation] - aaaaa
...
returnRates %>% kable(.,caption="Table 4.1.1 : Annual Return of Investment. ('0,000)")
```

*table 4.1.1* `r paste0(dim(returnRates), collapse=' x ')`
...
*table 4.1.2* `r paste0(dim(dat), collapse=' x ')`

  Above table list a part of sample odds prices and probabilities of soccer match $i$ while $n$ indicates the number of soccer matches. We can know the values `rEMProbB`, `netProbB` and also .
