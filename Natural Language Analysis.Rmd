...
mbase$datasets %>% head %>% datatable(., caption="Table 2.1 : Soccer Staking Data from Firm A", extensions=c('ColReorder', 'ColVis'), options=list(dom='TC<"clear">rfrtip', colVis=list(exclude=c(0), activate='mouseover'), scrollX=TRUE, scrollCollapse=TRUE))
```
...
spboData %>% head %>% datatable(., caption="Table 2.2 : SPBO Soccer Data", extensions=c('ColReorder', 'ColVis'), options=list(dom='TC<"clear">rfrtip', colVis=list(exclude=c(0), activate='mouseover'), scrollX=TRUE, scrollCollapse=TRUE))
```
