...
#### Stakes based reversed Kelly models
  ...
  Stakes based reversed Kelly models are the application of the parameter from reversion of the stakes where add-on some modified version Kelly models.
...
*table 4.3.2.2A* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *PL of Stakes reversed Kelly models year 2011~2015.*
...
tagList(
  tags$div(align = "center", 
           class = "bg-info", 
           tags$h3(class = "bg-primary", "PL of Stakes based reversed Kelly Models"), 
           tags$h5(align = "center", class = "text-muted", 
                   "Stakes of Firm A at Agency A (2011~2015) ($0,000)")), 
...
#### Reversed rEMProbB based Kelly models
  ...
  `rEMProbB` (real EM Probabilities Back) are the application of the parameter from reversion of the stakes where add-on some modified version Kelly models.

```{r data-Kelly2A, echo = FALSE, results = 'asis'}
...
*table 4.3.2.3A* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *League stakes profiling of firm A from 2011~2015.*

```{r data-Kelly2B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
