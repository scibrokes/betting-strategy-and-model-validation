...
```{r BRSum}
BRSummary <- readRDS('./data/BRSummary.rds')

BRSum <- ldply(BRSummary$KM, ldply) %>% tbl_df
write.csv(BRSum, './data/BRSum.csv')

BRSum.Op <- data.frame(BRSum[1:5], Op(BRSum)) %>% tbl_df
write.csv(BRSum.Op, './data/BRSum.Op.csv')

BRSum.Hi <- data.frame(BRSum[1:5], Hi(BRSum)) %>% tbl_df
write.csv(BRSum.Hi, './data/BRSum.Hi.csv')

BRSum.Lo <- data.frame(BRSum[1:5], Lo(BRSum)) %>% tbl_df
write.csv(BRSum.Lo, './data/BRSum.Lo.csv')

BRSum.Cl <- data.frame(BRSum[1:5], Cl(BRSum)) %>% tbl_df
write.csv(BRSum.Cl, './data/BRSum.Cl.csv')

BRSum.Vo <- data.frame(BRSum[1:5], Vo(BRSum)) %>% tbl_df
write.csv(BRSum.Vo, './data/BRSum.Vo.csv')

BRSum.Ad <- data.frame(BRSum[1:5], Ad(BRSum)) %>% tbl_df
