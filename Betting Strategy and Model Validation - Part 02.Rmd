...
>> Draft:
>> AIC and BIC
>> deviance required to compare the degree of freedom and residuals, and then refer to p value to determine the best fitted model.

>> prematch and In-Play need to separates.
```

  Base on above summary, we can decide that the model <s>xxxxxxxxxxxxxxxxxxx</s> is the best fit to determine the factors and effects to place stakes.
