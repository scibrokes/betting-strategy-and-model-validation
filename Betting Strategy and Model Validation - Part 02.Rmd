...
#'@ load('./regressionApps/shinyData.RData', envir = .GlobalEnv)
#'@ iniVal <- read_rds(path = './data/initial.rds') %>% .$KM %>% .[6] %>% as.character %>% as.numeric #leave only initial.rds and shinyData.RData and moved all previous funds objects into another folder to avoid overwrite the previous files.
...
#'@ save.image("~/GitHub/scibrokes/betting-strategy-and-model-validation/regressionApps/shinyData2.RData")
load('./regressionApps/shinyData.RData', envir = .GlobalEnv)
