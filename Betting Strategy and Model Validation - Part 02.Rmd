...
```{r data-Kelly1A, echo = FALSE, results = 'asis'}
...
```{r data-Kelly1B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
```{r data-Kelly1Mean-A, echo = FALSE, results = 'asis'}
...
#'@ save(K1mean1, file = './data/K1mean1.rda')
load('./data/K1mean1.rda')
...
```{r data-Kelly1Mean-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
```{r data-Kelly1Med-A, echo = FALSE, results = 'asis'}
## Applied various fractional Kelly models version II.
##   rEMProb based model without adjust the stakes.
...
## save above data to easier for loading.
#'@ save(K1mean2, file = './data/K1mean2.rda')
load('./data/K1mean2.rda')
...
```{r data-Kelly1Med-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
tagList(
  tags$div(align = "center", 
           ...
           tags$h5(align = "center", class = "text-muted", 
                   "Stakes of Firm A at Agency A (2011~2015) ($0,000)")), 
  as.htmlwidget(K1mean2 %>% formattable(list(
    Models = formatter('span', style = x ~ formattable::style(color = ifelse(rank(x) <= 3, 'blue', 'grey')), x ~ sprintf('%.6f (rank: %.0f)', x, rank(x))),
...
```{r data-Kelly2B-A, echo = FALSE, results = 'asis'}
...
```{r data-Kelly2B-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
```{r data-Kelly2Mean-A, echo = FALSE, results = 'asis'}
## reload the function due to unable found.
suppressMessages(source('./function/vKelly2.R'))
...
## save above data to easier for loading.
#'@ save(K2mean1, file = './data/K2mean1.rda')
load('./data/K2mean1.rda')
...
```{r data-Kelly2Mean-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
```{r data-Kelly2Med-A, echo = FALSE, results = 'asis'}
## reload the function due to unable found.
suppressMessages(source('./function/vKelly2.R'))
...
## save above data to easier for loading.
#'@ save(K2mean2, file = './data/K2mean2.rda')
load('./data/K2mean2.rda')
...
```{r data-Kelly2Med-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
```{r data-wKelly1A, echo = FALSE, results = 'asis'}
suppressMessages(library('knitr'))
suppressMessages(source('./function/vKelly.R'))
...
*table 4.3.3.2A* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed weighted Kelly models year 2012~2015.*

  From above table summary, we can know the range of risk management applicable to various adjusted Kelly models. Now we try to compare the Profit & Loss from below table.
  
```{r data-wKelly1B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
*table 4.3.3.2B* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes based reversed weighted Kelly models year 2012~2015.*

**Mean Fractional Models**

  Due to there has no league risk management profile, here I try to use the mean value of stakes on every single league as the baseline.

```{r data-wKelly1Mean-A, echo = FALSE, results = 'asis'}
## Applied various fractional Kelly models version II.
##   rEMProb based model without adjust the stakes.
K1 <- vKelly(mbase = suppressMessages(join(dat, lRiskProf)) %>% mutate(Stakes = mean))

kable(summary(K1$Kelly1$data), caption = 'Table 4.3.2.2C : Summary Table of Various Kelly Models (Stakes Reversed based with Mean Stakes Adjusted Models)')
```

*table 4.3.3.2C* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed weighted Kelly models (mean value of stakes as staking adjuster) year 2012~2015.*

  From above table summary, we can know the range of risk management applicable to various adjusted Kelly models. Now we try to compare the Profit & Loss from below table.
  
```{r data-wKelly1Mean-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))

tagList(
  tags$div(align = "center", 
           class = "bg-info", 
           tags$h3(class = "bg-primary", "PL of Reversed rEMProbB Kelly Models (Mean Stakes)"), 
           tags$h5(align = "center", class = "text-muted", 
                   "Stakes of Firm A at Agency A (2012~2015) ($0,000)")), 
  as.htmlwidget(K1$Kelly1$summary %>% formattable(list(
    Models = formatter('span', style = x ~ formattable::style(color = ifelse(rank(x) <= 3, 'blue', 'grey')), x ~ sprintf('%.6f (rank: %.0f)', x, rank(x))),
...
*table 4.3.3.2D* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes reversed weighted Kelly models (mean value of stakes as staking adjuster) year 2012~2015.*

**Median Fractional Models**

  Due to there has no league risk management profile, here I try to use the median value of stakes on every single league as the baseline.

```{r data-wKelly1Med-A, echo = FALSE, results = 'asis'}
## Applied various fractional Kelly models version II.
##   rEMProb based model without adjust the stakes.
K1 <- vKelly(mbase = suppressMessages(join(dat, lRiskProf)) %>% mutate(Stakes = median))

kable(summary(K1$Kelly1$data), caption = 'Table 4.3.2.2E : Summary Table of Various Kelly Models  (Stakes Reversed based with Median Stakes Adjusted Models)')
```

*table 4.3.3.2E* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed weighted Kelly models (median value of stakes as staking adjuster) year 2012~2015.*

  From above table summary, we can know the range of risk management applicable to various adjusted Kelly models. Now we try to compare the Profit & Loss from below table.
  
```{r data-wKelly1Med-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))

tagList(
  tags$div(align = "center", 
           class = "bg-info", 
           tags$h3(class = "bg-primary", "PL of Reversed Stakes based Kelly Models (Median Stakes)"), 
           tags$h5(align = "center", class = "text-muted", 
                   "Stakes of Firm A at Agency A (2012~2015) ($0,000)")), 
  as.htmlwidget(K1$Kelly1$summary %>% formattable(list(
    Models = formatter('span', style = x ~ formattable::style(color = ifelse(rank(x) <= 3, 'blue', 'grey')), x ~ sprintf('%.6f (rank: %.0f)', x, rank(x))),
...
*table 4.3.3.2F* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes reversed weighted Kelly models year (median value of stakes as staking adjuster) 2012~2015.*
...
```{r data-wKelly2B-A, echo = FALSE, results = 'asis'}
## reload the function due to unable found.
suppressMessages(source('./function/vKelly2.R'))
...
*table 4.3.3.3A* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB weighted Kelly models year 2012~2015.*

  From above table summary, we can know the range of risk management applicable to various adjusted Kelly models. Now we try to compare the Profit & Loss from below table.

```{r data-wKelly2B-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
*table 4.3.3.3B* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB weighted Kelly models year 2012~2015.*

**Mean Fractional Models**

  Due to there has no league risk management profile, here I try to use the mean value of stakes on every single league as the baseline.

```{r data-wKelly2Mean-A, echo = FALSE, results = 'asis'}
## reload the function due to unable found.
suppressMessages(source('./function/vKelly2.R'))
...
kable(summary(K2$Kelly1$data), caption = 'Table 4.3.2.3C : Summary Table of Various Kelly Models (Reversed rEMProbB based with Mean Stakes Adjusted models)')
```

*table 4.3.3.3C* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB weighted Kelly models year (mean value of stakes as staking adjuster) 2012~2015.*

  From above table summary, we can know the range of risk management applicable to various adjusted Kelly models. Now we try to compare the Profit & Loss from below table.
  
```{r data-wKelly2Mean-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))
...
*table 4.3.3.3D* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB weighted Kelly models (mean value of stakes as staking adjuster) year 2012~2015.*

**Median Fractional Models**

  Due to there has no league risk management profile, here I try to use the median value of stakes on every single league as the baseline.

```{r data-wKelly2Med-A, echo = FALSE, results = 'asis'}
## reload the function due to unable found.
suppressMessages(source('./function/vKelly2.R'))
...
kable(summary(K2$Kelly1$data), caption = 'Table 4.3.2.3E : Summary Table of Various Kelly Models (Reversed rEMProbB based with Mean Stakes Adjusted models)')
```

*table 4.3.3.3E* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB weighted Kelly models year (median value of stakes as staking adjuster) year 2012~2015.*

  From above table summary, we can know the range of risk management applicable to various adjusted Kelly models. Now we try to compare the Profit & Loss from below table.
  
```{r data-wKelly2Med-B, echo = FALSE, results = 'asis'}
#'@ suppressMessages(library('formattable'))

tagList(
  tags$div(align = "center", 
           class = "bg-info", 
           tags$h3(class = "bg-primary", "PL of Reversed rEMProbB Kelly Models (Median Stakes)"), 
           tags$h5(align = "center", class = "text-muted", 
                   "Stakes of Firm A at Agency A (2012~2015) ($0,000)")), 
  as.htmlwidget(K2$Kelly1$summary %>% formattable(list(
...
*table 4.3.3.3F* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB weighted Kelly models (median value of stakes as staking adjuster) year 2012~2015.*
...
K <- llply(split(dat2, dat$Result), function(x) x[sample(nrow(x), 2), c('Result', 'Return', 'EUPrice', 'HKPrice', 'Stakes', 'Rebates')]) %>% ldply(., .id = 'Result') %>% mutate(KReturn = currency(Return), Return = currency(Return), KStakes = currency(Stakes), Stakes = currency(Stakes), Rebates = percent(Rebates), Change = percent(KStakes / Stakes - 1)) %>% .[sample(nrow(.), nrow(.)), ]
...
```
  ...
  Application of Monte Carlo simulation. Based on the first year data, simulate the following matches from 2nd year onwards match-by-match to get the latest staking match result and predict the next staking match................
