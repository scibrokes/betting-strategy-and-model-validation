...
#'@ saveRDS(SOFund, file = './KellyApps/SOFund.rds')
...
ldply(BRSummary$KM, ldply, as.matrix) %>% datatable(
  caption = "Table 4.5.1.1 : Summary of Kelly Main Funds ('0,000)", 
...
*table 4.5.1.1 : Summary of `r length(BRSummary$KMnames)` Kelly main funds.*

  From *table 4.5.1.1* we can know the risk of the all investmental funds.
