...
*table 4.3.2.2C* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed Kelly models (mean value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.2.2D* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes reversed Kelly models (mean value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.2.2E* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed Kelly models (median value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.2.2F* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes reversed Kelly models year (median value of stakes as staking adjuster) 2011~2015.*
...
*table 4.3.2.3C* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB Kelly models year (mean value of stakes as staking adjuster) 2011~2015.*
...
*table 4.3.2.3D* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB Kelly models (mean value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.2.3E* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB Kelly models year (median value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.2.3F* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB Kelly models (median value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.3.2A* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed weighted Kelly models year 2011~2015.*
...
*table 4.3.3.2B* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes based reversed weighted Kelly models year 2011~2015.*
...
*table 4.3.3.2C* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed weighted Kelly models (mean value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.3.2D* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes reversed weighted Kelly models (mean value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.3.2E* : `r paste0(dim(K1$Kelly1$data), collapse = ' x ')` : *Summary of Stakes reversed weighted Kelly models (median value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.3.2F* : `r paste0(dim(K1$Kelly1$summary), collapse = ' x ')` : *PL of Stakes reversed weighted Kelly models year (median value of stakes as staking adjuster) 2011~2015.*
...
*table 4.3.3.3A* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB weighted Kelly models year 2011~2015.*
...
*table 4.3.3.3B* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB weighted Kelly models year 2011~2015.*
...
*table 4.3.3.3C* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB weighted Kelly models year (mean value of stakes as staking adjuster) 2011~2015.*
...
*table 4.3.3.3D* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB weighted Kelly models (mean value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.3.3E* : `r paste0(dim(K2$Kelly1$data), collapse = ' x ')` : *Summary of Reversed rEMProbB weighted Kelly models year (median value of stakes as staking adjuster) year 2011~2015.*
...
*table 4.3.3.3F* : `r paste0(dim(K2$Kelly1$summary), collapse = ' x ')` : *PL of Reversed rEMProbB weighted Kelly models (median value of stakes as staking adjuster) year 2011~2015.*
