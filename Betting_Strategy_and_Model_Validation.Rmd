...
author: "[?????, Eng Lian Hu](http://englianhu.wordpress.com) <img src='figure/ShirotoNorimichi.jpg' width='24'> ?????????????"
date: "`r Sys.Date()`"
output:
  html_document:
    fig_caption: yes
...
## 1.3 Professional Gambler
  ...
  - [???????????????????????????????????????](http://www.xinminweekly.com.cn/News/Content/878)
  - [???????????????:????????????156???????????????????????????"????????????"???](http://finance.sina.com.cn/roll/20120804/013612756650.shtml)
...
$$BR_N = (1 + K)^W(1 - K)^L BR_0$$   *equation 4.3.3*
  ...
  Kelly K-value [????????????????????????](http://ch-hsieh.blogspot.com/2015/01/kelly-criterion-0.html)
...
####  Reference for industry knowdelege and academic research portion for the paper.
  ...
  14) [ () - *????????????????????????*](http://ch-hsieh.blogspot.com/2015/01/kelly-criterion-0.html)
